...
def find_slots(club_slug: Annotated[str, "The slug of the club"],
               ...
               duration: Annotated[int | None, "Optional: The duration to filter by (minutes)"] = None) -> Annotated[list[Slot] | None, "The filtered slots."]:
...
def create_booking_link(club_id: Annotated[str, "The club id of the slot"],
    ...
    return utils_create_booking_link(club_id=club_id, court_id=court_id, time=time, duration=duration)
